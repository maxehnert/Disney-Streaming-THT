const constructTileRowFragment = (tile, title, tilesListFragment) => {
  ...
  const constructSingleTileFragment = ({ tileItem, tileImageUrl, tileTitle, showType, handleTileClick }) => {
    const fragment = document.createDocumentFragment();
    ...
    tileImageWrapper.onclick = (e) => handleTileClick(e, {tileItem, tileTitle, showType});
...
export { constructTileRowFragment, constructSingleTileFragment, constructModalFragment, createElement }